...
it("number literals", function()
  ...
  expect.generate_c("local a = 1_float128", "_Float128 a = 1.0q;")
...
it("c types", function()
  ...
  expect.generate_c("local a: float128", "_Float128 a;")
  ...
  expect.generate_c("do local a: float128 end", "_Float128 a = 0.0q;")
...
it("print builtin", function()
  ...
  expect.run_error_c([[local f: float128 print(f)]], "cannot handle type")
