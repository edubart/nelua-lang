...
it("missing symbols error suggestions", function()
  expect.analyze_error("tostring(0)", "maybe you forget to require module 'string'?")
  expect.analyze_error("io.write('')", "maybe you forget to require module 'io'?")
  expect.analyze_error("('a'):upper()", "maybe you forget to require module 'string'?")
  expect.analyze_error("string.format('%d', 1)", "maybe you forget to require module 'string'?")
end)
