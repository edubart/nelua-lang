...
/* OS */
  ...
  is_irix = true;
#endif
#if defined(__TIZEN_H__) || defined(TIZEN_DEPRECATION) || defined(__TIZEN__)
  is_tizen = true;
#endif
#if defined(__GAMEBOY__) || defined(__gba__) || defined(__GBA__)
  is_gameboy = true;
#endif
#if defined(_NDS) || defined(NDS) || defined(__NDS__) || defined (__NDS)
  is_nds = true;
#endif
#if defined(_3DS) || defined(__3DS__) || defined(__N3DS__)
  is_3ds = true;
#endif
#if defined(__SWITCH__) || defined(NINTENDO_SWITCH) || defined(__NX__) || defined(_SWITCH)
  is_switch = true;
#endif
#if defined(GAMECUBE) || defined(__GAMECUBE__) || defined(__gamecube__)
  is_gamecube = true;
#endif
#if defined(__WII__) || defined(WIIU) || defined(WII) || defined(wiiu) || defined(wii) || defined(_WII) || defined(_WIIU) || defined(__WIIU__) || defined(__wii__) || defined(__wiiu__)
  is_wii = true;
#endif
#if defined(__PSX__) || defined(PS1) || defined(__psx__) || defined(__PSONE__) || defined(PLAYSTATION_1) || defined(__PSX) || defined(_PSX)
  is_ps1 = true;
#endif
#if defined(__PS2__) || defined(_PS2) || defined(PS2) || defined(PLAYSTATION_2)
  is_ps2 = true;
#endif
#if defined(__PS3__) || defined(_PS3) || defined(__PS3) || defined(PS3) || defined(PLAYSTATION3) || defined(__PSL1GHT__)
  is_ps3 = true;
#endif
#if defined(PS4) || defined(ORBIS) || defined(__PS4__) || defined(__ORBIS__) || defined(_PS4) || defined(__PS4) || defined(PLAYSTATION4)
  is_ps4 = true;
#endif
#if defined(_PS5)
  is_ps5 = true;
#endif
#if defined(PSP) || defined(__PSP__) || defined(__psp__) || defined(__PSP) || defined(_PSP)
  is_psp = true;
#endif
#if defined(_PSVITA) || defined(VITA) || defined(__vita__) || defined(__PSVITA) || defined(__VITA__) || defined(_PSVITA) || defined(SN_TARGET_PSP2) || defined(__PSV__) || defined(__psv__) || defined(_PSV) || defined(__PSVita__) || defined(__PSVita)
  is_psvita = true;
#endif
#if defined(XBOX) || defined(__XBOX__) || defined(__XBOX) || defined(__xbox__) || defined(__xbox) || defined(_XBOX) || defined(xbox)
  is_xbox = true;
#endif
#if defined(_X360) || defined(XBOX360) || defined(__X360) || defined(__X360__)
  is_xbox360 = true;
#endif
#if defined(_XBOXONE) || defined(XBONE) || ((defined(_XBOX_ONE) || defined(_DURANGO)) && defined(_TITLE))
  is_xbox_one = true;
#endif
