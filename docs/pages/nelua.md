...
[![Join the chat at Gitter](https://badges.gitter.im/nelua-lang/Lobby.svg)](https://gitter.im/nelua-lang/Lobby?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
...
uses a Lua VM such as Lua or LuaJIT, therefore Nelua has different goals of other JIT or VM
...
```shell
nelua -g c examples/snakesdl.nelua
```
...
|    ackermann |  nelua c |     56.027 |     60.481 |     65.138 |      2.319 |
...
|    fibonacci |  nelua c |    326.133 |    329.366 |    332.112 |      2.069 |
...
|     heapsort |  nelua c |    176.590 |    181.156 |    190.310 |      5.473 |
...
* Check out the language [manual](https://edubart.github.io/nelua-lang/manual/)
